...
> **AVISO LEGAL:** Este projeto foi desenvolvido com fins estritamente educacionais e de conscientização em segurança da informação. O uso deste código em sistemas ou redes sem autorização prévia é ilegal. Não utilize para fins maliciosos.
